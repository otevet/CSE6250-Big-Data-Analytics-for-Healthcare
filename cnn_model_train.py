...
def parse_args():
    ...
    parser.add_argument('--datafile',  dest='datafile', help='input pickle file', default='./data/DATA_WORDSEQV1_HADM_TOP50.p', type = str)
    parser.add_argument('--embmatrix', dest='embmatrix', help='embedding matrix', default='./data/EMBMATRIXV1_WORD2VEC_v2_300dim.p', type = str)
    ...
    parser.add_argument('--model_name', dest='model_name', help='model loaded from *_model.py', default='cnn_text', type=str)
